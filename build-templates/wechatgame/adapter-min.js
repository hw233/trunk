! function i (a, c, u) {
    ...
    2: [function (e, t, n) {
        ...
        var r = window.fsUtils,
            ...
            y = [],
            b = !1,
            _ = /the maximum size of the file storage/,
            w = 0,
            E = /^https?:\/\/.*/,
            x = {
                cacheDir: "gamecaches",
                ...
                _cache: function () {
                    ...
                    for (var n in this.cacheQueue) {
                        var e = function (e) {
                                if (h = !1, e) {
                                    if (_.test(e.message)) return t.outOfStorage = !0, void(t.autoClear && t.clearLRU())
                            ...
                            c = Date.now().toString(),
                            u = "",
                            u = a ? "".concat(this.cacheDir, "/").concat(a, "/").concat(c).concat(w++).concat(cc.path.extname(n)) : "".concat(this.cacheDir, "/").concat(c).concat(w++).concat(cc.path.extname(n));
                ...
                cacheFile: function (e, t, n, r, o) {
                    ///////////////////////////////////////// hook /////////////////////////////////////////
                    var uuid = cc.assetManager.utils.getUuidFromURL(e);
                    if (uuid) {
                        var info = cc.resources.getAssetInfo(uuid);
                        if (info && info.path && [
                                'map/',
                                'music/',
                                'sound/',
                                'spine/',
                            ].some(i => info.path.startsWith(i))) {
                            // 忽略某些目录，不可在至缓存
                            return;
                        }
                    }
                ...
                unzipAndCacheBundle: function (t, e, n, r) {
                    var o = Date.now().toString(),
                        i = "".concat(this.cacheDir, "/").concat(n, "/").concat(o).concat(w++),
                        a = this;
    ...
    3: [function (e, t, n) {
        ...
        s.downloadDomAudio = E, s.downloadScript = w, l.parsePVRTex = D, l.parsePKMTex = P, s.register({
            ".js": w,
            ".mp3": C,
            ".ogg": C,
            ".wav": C,
            ...
            bundle: function (e, u, s) {
                ...
                })) : (g.test(e) || !y && e.startsWith(m()) ? (l = e, t = "src/scripts/".concat(r, "/index.js"), f.makeBundleFolder(r)) : _[r] ? (l = "".concat(i, "remote/").concat(r), t = "src/scripts/".concat(r, "/index.js"), f.makeBundleFolder(r)) : (l = "assets/".concat(r), t = "assets/".concat(r, "/index.js")), __cocos_require__(t), u.__cacheBundleRoot__ = r, n = "".concat(l, "/config.").concat(o ? o + "." : "", "json"), O(n, u, function (e, o) {
                    var t, n, r, i, a, c;
        ...
        var L, F = y ? function (e, t) {
            ...
            var n, r, o = !1,
                i = !1;
            return !e.startsWith(m()) && g.test(e) ? t.reload || ((n = f.cachedFiles.get(e)) ? (i = !0, e = n.url) : (r = f.tempFiles.get(e)) && (o = !0, e = r)) : o = !0, {
                url: e,
                inLocal: o,
                inCache: i
            }
        ...
        y ? (L = cc.assetManager.init, cc.assetManager.init = function (e) {
            ...
            for (var t = e.output = e.input, n = 0, r = t.length; n < r; n++) {
                var o = t[n],
                    i = o.options;
                if (o.config) i.__cacheBundleRoot__ = o.config.name;
                else {
        ...
        Object.assign(i, {
            ...
            _runMainLoop: function () {
                ...
                this._banRunningMainLoop || (n = (e = this).config, r = cc.director, o = !0, i = n.frameRate, cc.debug.setDisplayStats(n.showFPS), t = function () {
                    if (!e._paused) {
                        if (e._intervalId = window.requestAnimFrame(t), 30 === i && !__globalAdapter.setPreferredFramesPerSecond && (o = !o)) return;
                        r.mainLoop()
                    }
    ...
    20: [function (e, t, n) {
        ...
        u.prototype = Error.prototype, r(a, u), p.prototype = {
            ...
            normalize: function () {
                for (var e = this.firstChild; e;) {
                    var t = e.nextSibling;
                    t && t.nodeType == _ && e.nodeType == _ ? (this.removeChild(t), e.appendData(t.data)) : (e.normalize(), e = t)
                }
            },
            ...
            _inc: 1,
            insertBefore: function (e, t) {
                if (e.nodeType != O) return null == this.documentElement && e.nodeType == y && (this.documentElement = e), L(this, e, t), e.ownerDocument = this, e;
        ...
        }).getElementsByTagName, P.prototype.getElementsByTagNameNS = F.prototype.getElementsByTagNameNS, o(F, A), k.prototype.nodeType = b, o(k, A), H.prototype = {
            data: "",
            ...
            nodeType: w
        }, o(V, H), W.prototype.nodeType = N, o(W, A), K.prototype.nodeType = 12, o(K, A), G.prototype.nodeType = 6, o(G, A), z.prototype.nodeType = E, o(z, A), q.prototype.nodeName = "#document-fragment", q.prototype.nodeType = O, o(q, A), $.prototype.nodeType = x, o($, A), X.prototype.serializeToString = function (e, t, n) {
            return Y.call(e, t, n)
                                ...
                                switch (h < v && t(v), n.charAt(v + 1)) {
                                    case "/":
                                        var y = n.indexOf(">", v + 3),
                                            b = n.substring(v + 2, y),
                                            _ = d.pop();
                                        y < 0 ? (b = n.substring(v + 2).replace(/[\s<].*/, ""), i.error("end tag name: " + b + " is not complete:" + _.tagName), y = v + 1 + b.length) : b.match(/\s</) && (b = b.replace(/[\s<].*/, ""), i.error("end tag name: " + b + " maybe not complete"), y = v + 1 + b.length);
                                        var w = _.localNSMap,
                                            E = _.tagName == b;
                                        if (E || _.tagName && _.tagName.toLowerCase() == b.toLowerCase()) {
                                            if (o.endElement(_.uri, _.localName, b), w)
                                                for (var x in w) o.endPrefixMapping(x);
    ...
    25: [function (e, t, n) {
        ...
        Object.defineProperty(n, "__esModule", {
            ...
            var e = null;
            if (wx.__first__canvas) {
                e = wx.__first__canvas;
                wx.__first__canvas = null;
                delete wx.__first__canvas;
            } else {
                e = wx.createCanvas();
            }
            e.type = "canvas";
    ...
    52: [function (e, t, n) {
        "use strict";
        var v, y, b, r, o;
        cc && cc.VideoPlayer && cc.VideoPlayer.Impl && __globalAdapter.createVideo && (v = cc.Mat4, y = cc.mat4(), b = cc.mat4(), r = cc.VideoPlayer.Impl, o = cc.VideoPlayer.Impl.prototype, cc.VideoPlayer.prototype._updateVideoSource = function () {
            var t = this,
                n = this._clip;
            ...
            __globalAdapter.createVideo ? this._video || (this._video = __globalAdapter.createVideo(), this._video.showCenterPlayBtn = !1, this._video.controls = !1, this._duration = 0, this._currentTime = 0, this._loaded = !1, this.setVisible(!1), this._bindEvent()) : cc.warn("VideoPlayer not supported")
        }, o.setURL = function (e) {
            var t, n = this._video;
            n && n.src !== e && (n.stop(), this._unbindEvent(), n.autoplay = !0, n.src = e, n.muted = !0, (t = this)._loaded = !1, n.onPlay(function () {
                n.offPlay(), t._bindEvent(), n.stop(), n.muted = !1, t._loaded = !0, t._playing = !1, t._currentTime = 0, t._dispatchEvent(r.EventType.READY_TO_PLAY), n.autoplay = !1
            }))
        }, o.getURL = function () {
            var e = this._video;
            return e ? e.src : ""
            ...
            this._video && this._visible && ((t = cc.Camera.findCamera(e)) && (e.getWorldMatrix(y), this._m00 === y.m[0] && this._m01 === y.m[1] && this._m04 === y.m[4] && this._m05 === y.m[5] && this._m12 === y.m[12] && this._m13 === y.m[13] && this._w === e._contentSize.width && this._h === e._contentSize.height || (this._m00 = y.m[0], this._m01 = y.m[1], this._m04 = y.m[4], this._m05 = y.m[5], this._m12 = y.m[12], this._m13 = y.m[13], this._w = e._contentSize.width, this._h = e._contentSize.height, t.getWorldToScreenMatrix2D(b), v.multiply(b, b, y), n = cc.view._scaleX, r = cc.view._scaleY, n /= o = cc.view._devicePixelRatio, r /= o, i = b.m[0] * n, a = b.m[5] * r, c = this._w * i, u = this._h * a, s = c * e._anchorPoint.x, l = u * e._anchorPoint.y, d = (f = cc.view._viewportRect).x / o, p = f.y / o, h = b.m[12] * n - s + d, m = b.m[13] * r - l + p, g = cc.view.getFrameSize().height, this._video.x = h, this._video.y = g - u - m, this._actualWidth = this._video.width = c, this._video.height = u)))
        })
    }, {}],
    53: [function (e, t, n) {
        "use strict";
        ...
        var o = wx.getFileSystemManager ? wx.getFileSystemManager() : null,
            c = {
                ...
                readJson: function (r, o) {
                    if (typeof wx.__parse__json === 'function') {
                        c.readFile(r, "", function (t, e) {
                            var n = null
                            if (!t) try {
                                n = wx.__parse__json(e)
                            } catch (e) {
