 ...
 * @Last Modified time: 2021-05-07 16:29:14
 */

export default class BStringUtils {
    /**
    ...
    */
    public static isNotEmpty(str: string) {
        return !BStringUtils.isEmpty(str);
    }
    ...
    */
    ...
    public static isNotBlank(str: string) {
        return !BStringUtils.isBlank(str);
    }
    ...
    */
    public static clean(str: string) {
        return str == null ? BStringUtils.EMPTY : str.trim();
    }
    ...
    */
    public static trimToNull(str: string) {
        let ts = BStringUtils.trim(str);
        return BStringUtils.isEmpty(ts) ? null : ts;
    }
    ...
    */
    public static replace(text: string, searchString: string, replacement: string, max?: number) {
        ...
        if (BStringUtils.isEmpty(text) || BStringUtils.isEmpty(searchString) || replacement === null || max === 0) {
            return text;
        }
        let start = 0;
        let end = text.indexOf(searchString, start);
        if (end === BStringUtils.INDEX_NOT_FOUND) {
            return text;
        }
        ...
        let buf = new Array();
        while (end !== BStringUtils.INDEX_NOT_FOUND) {
