...
import { Adventure_passCfg, GlobalCfg, Store_miscCfg } from '../../../a/config';
...
@ccclass
@menu("qszc/view/adventure/AdvPassPortBuyViewCtrl")
export default class AdvPassPortBuyViewCtrl extends gdk.BasePanel {
