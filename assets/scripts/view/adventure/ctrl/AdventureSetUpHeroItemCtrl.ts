...
import { Adventure_hireCfg, Adventure_themeheroCfg, HeroCfg } from '../../../a/config';
 ...
 * @Last Modified time: 2021-05-06 15:22:38
 */
...
@ccclass
@menu("qszc/view/adventure/AdventureSetUpHeroItemCtrl")
export default class AdventureSetUpHeroItemCtrl extends UiListItem {
    ...
    updateView() {
        ...
        if (item.series > 900000) {
            this.hireNode.active = true
            let info: icmsg.AdventureHero = AdventureUtils.getHireHero(item.series)
        ...
        let recommendIds = []
        let themeheroCfg = ConfigManager.getItemByField(Adventure_themeheroCfg, "type", AdventureUtils.actRewardType, { difficulty: this.adventureModel.difficulty })
