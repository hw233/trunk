 ...
 * @Last Modified time: 2021-04-29 20:59:19
 */

@ccclass
@menu("qszc/view/role2/guardian/equip/GuardianEquipStrengthenItemCtrl")
export default class GuardianEquipStrengthenItemCtrl extends UiListItem {
    ...
    _updateRedpoint() {
        ...
        if (heroInfo && heroInfo.heroId > 0) {
            ...
            this.redPoint.active = RedPointUtils.is_can_guardian_equip_strength(heroInfo, equipCfg.part)
        }
    }
