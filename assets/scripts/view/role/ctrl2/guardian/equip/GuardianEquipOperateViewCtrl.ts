...
/** 
 * @Description: 守护者装备操作主界面 强化 突破
 * @Author: luoyong
 * @Date: 2019-05-08 14:30:43 
 * @Last Modified by: luoyong
 * @Last Modified time: 2021-04-19 11:48:12
 */

@ccclass
@menu("qszc/view/role2/guardian/equip/GuardianEquipOperateViewCtrl")
export default class GuardianEquipOperateViewCtrl extends gdk.BasePanel {
    ...
    onDisable() {
        ...
        guardianModel.curSelectGuardianEquip = null
    }
    ...
    checkArgs() {
        let args = gdk.panel.getArgs(PanelId.GuardianEquipOperateView)
        let idx = 0;
