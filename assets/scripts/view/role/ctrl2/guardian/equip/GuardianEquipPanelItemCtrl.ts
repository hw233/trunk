 ...
 * @Last Modified time: 2021-04-29 20:14:41
 */
...
@ccclass
@menu("qszc/view/role2/guardian/equip/GuardianEquipPanelItemCtrl")
export default class GuardianEquipPanelItemCtrl extends UiListItem {
    ...
    updateView() {
        ...
        if (heroInfo && heroInfo.heroId > 0) {
            ...
            this.redPoint.active = RedPointUtils.is_can_inHero_guardian_equip_strength(heroInfo) || RedPointUtils.is_can_inHero_guardian_equip_change_max_power(heroInfo) || RedPointUtils.is_can_inHero_guardian_equip_break(heroInfo)
        }
    }
