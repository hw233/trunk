 ...
 * @Last Modified time: 2021-06-09 20:07:48
 */
...
@ccclass
@menu("qszc/view/arenaHonor/ArenaHonorRewardViewCtrl")
export default class ArenaHonorRewardViewCtrl extends gdk.BasePanel {
