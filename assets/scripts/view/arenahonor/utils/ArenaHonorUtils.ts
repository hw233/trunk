...
export default class ArenaHonorUtils {
    ...
    static getTimesById(id: number) {
        ...
        let cfg = ConfigManager.getItemById(Arenahonor_progressCfg, id);
    ...
    static getCurProgressId() {
        ...
        let cfgs = ConfigManager.getItems(Arenahonor_progressCfg);
