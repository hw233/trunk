 ...
 * @Last Modified time: 2020-09-15 13:55:14
 */

const { ccclass, property, menu } = cc._decorator;

@ccclass
@menu("qszc/view/task/scoreSystem/ScoreSystemViewCtrl")
export default class ScoreSystemViewCtrl extends gdk.BasePanel {
