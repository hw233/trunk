 ...
 * @Last Modified time: 2021-08-25 16:41:02
 */
...
@ccclass
@menu("qszc/view/worldhonor/HonorDefenderSetUpHeroSelectorCtrl")
export default class HonorDefenderSetUpHeroSelectorCtrl extends gdk.BasePanel {
    ...
    openDefenderView() {
        ...
        this.close()
        let temStr: 'FOOTHOLD' | 'ARENA' | 'CHAMPION_GUESS' | 'CHAMPION_MATCH' | 'RELIC' | "VAULT" | "ENDRUIN" | 'ARENATEAM' | 'PEAK' | 'FOOTHOLD_GATHER' | 'ARENAHONOR_GUESS' | 'WORLDHONOR_GUESS' = 'ARENAHONOR_GUESS';
