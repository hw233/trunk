...
/** 
  * @Author: jiangping  
  * @Description: 
  * @Date: 2021-07-14 15:24:39 
  */
const { ccclass, property, menu } = cc._decorator;

@ccclass
@menu("qszc/view/lottery/EnergyStoneSumupViewCtrl")
export default class EnergyStoneSumupViewCtrl extends gdk.BasePanel {
    ...
    onTabMenuSelect(e, data) {
        ...
        gdk.e.emit(LotteryEventId.HERO_RESET_TYPE_CHANGE, [0, data])
    }
}
