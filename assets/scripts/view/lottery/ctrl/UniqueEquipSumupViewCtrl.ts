 ...
 * @Last Modified time: 2021-09-13 16:24:48
 */
const { ccclass, property, menu } = cc._decorator;

@ccclass
@menu("qszc/view/lottery/UniqueEquipSumupViewCtrl")
export default class UniqueEquipSumupViewCtrl extends gdk.BasePanel {
    ...
    onTabMenuSelect(e, data) {
        ...
        gdk.e.emit(LotteryEventId.HERO_RESET_TYPE_CHANGE, [5, data])
    }
}
