 ...
 * @Last Modified time: 2021-07-14 15:27:41
 */
const { ccclass, property, menu } = cc._decorator;

@ccclass
@menu("qszc/view/lottery/CostumeSumupViewCtrl")
export default class CostumeSumupViewCtrl extends gdk.BasePanel {
    ...
    onTabMenuSelect(e, data) {
        ...
        gdk.e.emit(LotteryEventId.HERO_RESET_TYPE_CHANGE, [3, data])
    }
}
