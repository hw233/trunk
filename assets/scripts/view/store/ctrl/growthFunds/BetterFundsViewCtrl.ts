 ...
 * @Last Modified time: 2021-07-30 19:12:39
*/
...
@ccclass
@menu("qszc/view/store/growthFunds/BetterFundsViewCtrl")
export default class BetterFundsViewCtrl extends gdk.BasePanel {
    ...
    @gdk.binding('storeModel.betterFundsInfo')
    _refreshViewInfo() {
    ...
    getFunc() {
        ...
        NetManager.send(msg, (data: icmsg.PassFundFetchRsp) => {
            ...
            this.storeModel.betterFundsInfo = data.fund
