...
/** 
  * @Author: jiangping  
  * @Description: 
  * @Date: 2021-07-21 10:35:50 
  */
const { ccclass, property, menu } = cc._decorator;

@ccclass
@menu("qszc/view/act/costumeCustom/CostumeCustomMainCtrl")
export default class CostumeCustomMainCtrl extends gdk.BasePanel {
    @property(cc.Node)
    tabBtns: cc.Node[] = [];
    ...
    onEnable() {
        ...
        gdk.e.on("popup#CostumeCustomGiftView#close", this._hideLinkGameGiftViewFunc, this);
    }
    onDisable() {
        gdk.e.off("popup#CostumeCustomGiftView#close", this._hideLinkGameGiftViewFunc, this);
    ...
    _updateBtns() {
        this.tabBtns[1].active = ActivityUtils.getCostumeCustomGiftDatas().length > 0;
    ...
    checkArgs() {
        ...
        let args = gdk.panel.getArgs(PanelId.CostumeCustomMain)
        let idx = 0;
