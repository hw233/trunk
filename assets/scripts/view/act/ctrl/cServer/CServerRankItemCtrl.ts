...
@ccclass
export default class CServerRankItemCtrl extends UiListItem {
    ...
    updateView() {
        ...
        this.serverName.string = 'S' + (this.info.serverId % 10000) + '  ' + ModelManager.get(ServerModel).serverNameMap[this.info.serverId]
