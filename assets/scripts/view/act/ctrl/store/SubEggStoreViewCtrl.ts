 ...
 * @Last Modified time: 2020-12-22 11:37:41
 */

const { ccclass, property, menu } = cc._decorator;

@ccclass
@menu("qszc/view/act/store/SubEggStoreViewCtrl")
export default class SubEggStoreViewCtrl extends gdk.BasePanel {
    @property(cc.Label)
    ...
    _updateView() {
        ...
        let cfgs = ConfigManager.getItems(Operation_storeCfg, (cfg: Operation_storeCfg) => {
            if (cfg.reward_type == this.cfg.reward_type && cfg.page == 1) return true;
        });
