 ...
 * @Last Modified time: 2021-04-09 11:39:57
 */
const { ccclass, property, menu } = cc._decorator;

@ccclass
@menu("qszc/view/act/heroTrial/HeroTrialStageRewardItemCtrl")
export default class HeroTrialStageRewardItemCtrl extends UiListItem {
    ...
    info: { cfg: OrdealCfg, index: number, curCfg: OrdealCfg, isLast: boolean }  //state 0 已领取 1可领取 2 不可领取
    ...
    updateView() {
        ...
        if (stageId == 0) {
            ...
            if (this.info.cfg.round <= stageId) {
                ...
                GlobalUtil.setGrayState(this.attackBtn, btnState);
                ...
                this.yilingqu.active = false;
                this.attackBtn.active = true;
                GlobalUtil.setGrayState(this.attackBtn, 1);
                this.btnState = 2;
            }
        }
