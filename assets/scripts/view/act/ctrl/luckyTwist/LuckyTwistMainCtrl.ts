 ...
 * @Last Modified time: 2021-04-09 18:24:56
 */
...
@ccclass
@menu("qszc/view/act/luckyTwist/LuckyTwistMainCtrl")
export default class LuckyTwistMainCtrl extends gdk.BasePanel {
    ...
    onDisable() {
        ...
        storeModel.starGiftDatas = storeModel.starGiftDatas
    }
