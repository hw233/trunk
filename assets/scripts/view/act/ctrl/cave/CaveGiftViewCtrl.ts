...
/** 
  * @Author: jiangping  
  * @Description: 
  * @Date: 2021-05-07 10:45:30 
  */
const { ccclass, property, menu } = cc._decorator;

@ccclass
@menu("qszc/view/act/cave/CaveGiftViewCtrl")
export default class CaveGiftViewCtrl extends gdk.BasePanel {
  @property(cc.Label)
  ...
  _onPaySucc(e: gdk.Event) {
    ...
    if (cfg && cfg.event_type == 4 && this.showCloseBtn) {
      this.close();
    }
  }
