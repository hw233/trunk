...
import NewHeroTrialRankItemCtrl from './NewHeroTrialRankItemCtrl';
import PanelId from '../../../../configs/ids/PanelId';
import RoleModel from '../../../../common/models/RoleModel';
import TimerUtils from '../../../../common/utils/TimerUtils';
import { ListView, ListViewDir } from '../../../../common/widgets/UiListview';
import { Newordeal_ordealCfg, Newordeal_rankingCfg } from '../../../../a/config';
 ...
 * @Last Modified time: 2021-04-08 17:37:02
 */
const { ccclass, property, menu } = cc._decorator;

@ccclass
@menu("qszc/view/act/newHeroTrial/NewHeroTrialRankViewCtrl")
export default class NewHeroTrialRankViewCtrl extends gdk.BasePanel {
    ...
    @property(NewHeroTrialRankItemCtrl)
    myRankItem: NewHeroTrialRankItemCtrl = null;
    ...
    onEnable() {
        let arg = gdk.panel.getArgs(PanelId.NewHeroTrialRankView);
        if (arg) {
    ...
    _updateView1(resetPos: boolean = true) {
        ...
        let myInfo = {
            brief: brief,
            value: tem,
            rank: this.model.newHeroTrialInfo.rankNum
        };
    ...
    _updateView2(resetPos: boolean = true) {
        ...
        if (cfgs.length > 0) {
            for (let i = 0; i < cfgs.length; i++) {
                ...
                let cfg = cfgs[i]
                let nameStr = cfg.rank[0] == cfg.rank[1] ? cfg.rank[0] + '' : cfg.rank[0] + '~' + cfg.rank[1];
