...
import { Newordeal_ordealCfg } from '../../../../a/config';
 ...
 * @Last Modified time: 2021-04-09 14:48:41
 */
...
@ccclass
@menu("qszc/view/act/newHeroTrial/NewHeroTrialStageRewardViewCtrl")
export default class NewHeroTrialStageRewardViewCtrl extends gdk.BasePanel {
    ...
    onEnable() {
        let arg = gdk.panel.getArgs(PanelId.NewHeroTrialStageRewardView);
        if (arg) {
