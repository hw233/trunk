 ...
 * @Last Modified time: 2021-05-19 16:55:35
 */
const { ccclass, property, menu } = cc._decorator;

@ccclass
@menu("qszc/view/act/newHeroTrial/NewHeroTrialRankItemCtrl")
export default class NewHeroTrialRankItemCtrl extends UiListItem {
    ...
    //打开伤害统计界面  
    openDamageView() {
        gdk.panel.setArgs(PanelId.NewHeroTrialDamageView, this.value)
        gdk.panel.open(PanelId.NewHeroTrialDamageView);
    }
}
