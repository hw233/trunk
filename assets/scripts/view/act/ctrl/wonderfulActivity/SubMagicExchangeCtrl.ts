...
import { Secretarea_storeCfg, TipsCfg } from '../../../../a/config';
/**
 * 魔幻活动 子界面
 * @Author: luoyong
 * @Date: 2019-04-09 18:08:59
 * @Last Modified by: luoyong
 * @Last Modified time: 2020-12-21 11:44:44
 */
...
@ccclass
@menu("qszc/view/act/wonderfulActivity/SubMagicExchangeCtrl")
export default class SubMagicExchangeCtrl extends gdk.BasePanel {
    ...
    _updateTime() {
        ...
        let endTime = Math.floor(ActUtil.getActEndTime(34) / 1000)
        ...
        if (leftTime > 0) {
            ...
            let c_endTime = Math.floor(ActUtil.getActEndTime(35) / 1000)
    ...
    _updateContentDes() {
        ...
        let tipCfg = ConfigManager.getItemById(TipsCfg, 38)
    ...
    _updateRewardContent() {
        ...
        let storeCfg = ConfigManager.getItemByField(Secretarea_storeCfg, "activity", 35, { reward_type: actCfg.reward_type })
    ...
    openMagicStore() {
        gdk.panel.open(PanelId.MagicStore)
    }
}