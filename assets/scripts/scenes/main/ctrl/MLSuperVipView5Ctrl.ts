...
@ccclass
@menu("qszc/scene/main/MLSuperVipView5Ctrl")
export default class MLSuperVipView5Ctrl extends gdk.BasePanel {
    @property(cc.Node)
    ...
    onTipBtnClick() {
        if (this.redNode.active) {
            ...
            this.redNode.stopAllActions();
            let actType = ActUtil.getActRewardType(142);
            GlobalUtil.setLocal('mlSuperVipActType5', actType, true);
        }
    }
}
