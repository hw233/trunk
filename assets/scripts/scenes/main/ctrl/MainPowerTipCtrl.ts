 ...
 * 战力提示界面控制组件类
 * @Author: sthoo.huang
 * @Date: 2019-08-30 16:20:50
 * @Last Modified by: jiangping
 * @Last Modified time: 2021-06-18 11:23:19
 */

const { ccclass, property, menu } = cc._decorator;

@ccclass
@menu("qszc/scene/main/MainPowerTipCtrl")
export default class MainPowerTipCtrl extends gdk.BasePanel {
    ...
    update() {
        ...
        if (args && args.length == 2) {
            this.updateTip(args[0], args[1] || 0);
        }
    }
