...
@ccclass
@menu("qszc/scene/main/MLSuperVipView4Ctrl")
export default class MLSuperVipView4Ctrl extends gdk.BasePanel {
    @property(cc.Node)
    ...
    onEnable() {
        ...
        let show = ActUtil.ifActOpen(141);
    ...
    onTipBtnClick() {
        if (this.redNode.active) {
            ...
            this.redNode.stopAllActions();
            let actType = ActUtil.getActRewardType(141);
            GlobalUtil.setLocal('mlSuperVipActType4', actType, true);
        }
    }
}
