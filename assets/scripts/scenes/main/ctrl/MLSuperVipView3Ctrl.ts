 ...
 * @Last Modified time: 2021-09-06 11:09:13
 */
const { ccclass, property, menu } = cc._decorator;

@ccclass
@menu("qszc/scene/main/MLSuperVipView3Ctrl")
export default class MLSuperVipView3Ctrl extends gdk.BasePanel {
    @property(cc.Node)
    ...
    onEnable() {
        ...
        let show = ActUtil.ifActOpen(128);
    ...
    onTipBtnClick() {
        if (this.redNode.active) {
            ...
            this.redNode.stopAllActions();
            let actType = ActUtil.getActRewardType(128);
            GlobalUtil.setLocal('mlSuperVipActType3', actType, true);
        }
    }
}
